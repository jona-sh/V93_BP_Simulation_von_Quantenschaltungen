.. q_simulator_bp_feljon documentation master file, created by
   sphinx-quickstart on Wed Sep 16 16:05:52 2026.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

q_simulator_bp_feljon documentation
=========================

``q_simulator_bp_feljon`` is an educational quantum-circuit simulator. It accepts
