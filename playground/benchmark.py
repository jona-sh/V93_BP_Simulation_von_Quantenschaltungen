...
plt.plot(qubits_iterate, data_qubits["einsum"], label="einsum")
plt.plot(qubits_iterate, data_qubits["loop"], label="loop")
...
plt.plot(depths_iterate, data_depths["einsum"], label="einsum")
plt.plot(depths_iterate, data_depths["loop"], label="loop")
